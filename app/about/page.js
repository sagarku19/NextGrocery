...
export default function AboutPage() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-teal-500 to-emerald-600 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <Image 
            src="https://images.unsplash.com/photo-1506617564039-2f3b650b7010?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
        ...
        <div className="container mx-auto px-4 py-20 relative">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">About NextGrocery</h1>
            <p className="text-lg text-white opacity-90 mb-8">
              We're on a mission to revolutionize grocery shopping with fresh products delivered to your doorstep.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p>
              NextGrocery was founded in 2023 with a simple yet powerful vision: to make grocery shopping convenient, 
              affordable, and sustainable for everyone. What started as a small local operation has grown into a
              customer-focused service that connects people with fresh produce and quality goods.
            </p>
            <p>
              We believe that everyone deserves access to high-quality groceries without the hassle of navigating crowded 
              stores or carrying heavy bags. By leveraging technology and building strong relationships with local 
              suppliers, we've created a platform that simplifies the grocery shopping experience while supporting 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600">
                We meticulously source our products, ensuring that only the freshest and highest-quality items
                reach your doorstep.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600">
                We're committed to environmentally friendly practices, from locally sourced products to 
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600">
                We support local producers and businesses, fostering strong relationships with the communities
                we serve and creating jobs in the areas we operate.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-teal-600 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-semibold text-white mb-6">Ready to experience NextGrocery?</h2>
          <p className="text-lg text-white opacity-90 mb-8 max-w-3xl mx-auto">
            Join thousands of satisfied customers who have simplified their grocery shopping experience.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              href="/"
              className="px-6 py-3 bg-white text-teal-600 font-medium rounded-md shadow-sm hover:bg-gray-100 transition-colors"
            >
              Start Shopping
            </Link>
            <Link 
              href="/contact"
              className="px-6 py-3 bg-transparent text-white border border-white font-medium rounded-md hover:bg-white hover:text-teal-600 transition-colors"
            >
              Contact Us
            </Link>
          </div>
