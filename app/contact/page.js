            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    hello@nextgrocery.com<br />
                    support@nextgrocery.com
                  </p>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <button
                    ...
                    className="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-teal-500 to-emerald-600 text-white font-medium rounded-md shadow-sm hover:from-teal-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                  >
      ...
      <div className="mt-12">
        <div className="relative h-96 w-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-medium text-gray-800">NextGrocery HQ</h3>
            <p className="text-gray-600">123 Grocery Street, San Francisco</p>
          </div>
        </div>
      </div>
    </div>
